...
/* NYT Timestamp: 2026-06-16 18:15:22 */
...
(function() {
    ...
    window.addEventListener('error', function(e) {
        if (e.target && e.target.tagName === 'IMG') {
            ...
            // EXTENDED: If a broken image link is flagged within the community photo gallery, completely drop its parent card block wrapper
            const frame = e.target.closest('.showcase-media-canvas, .clipping-card-image-box, .showcase-card-body');
            if (frame) {
            ...
            if(Array.isArray(events) && events.length > 0) {
                ...
                events.forEach((item) => {
                    ...
                    validEvents.push({ 
                        ...
                        dateEnd: item.dateEnd || item.endDate || null,
                        title: title, 
                        location: location, 
                        details: descText,
    ...
    async function loadRegionalMapsEngine() {
        ...
        try {
            const localMapsManifest = {
                "flora": {
                    "name": "Flora, IL",
                    "src": "https://ourflora.com/wp-content/uploads/2025/02/R.jpg",
                    "alt": "Community map of Flora, IL",
                    "url": "https://ourflora.com"
                },
                "clay_city": {
                    "name": "Clay City, IL",
                    "src": "https://townmapsusa.com/images/maps/map_of_clay_city_il.jpg",
                    "alt": "Community map of Clay City, IL",
                    "url": "https://werewolf3788.github.io/Testpages/clay-city.html"
                },
                "xenia": {
                    "name": "Xenia, IL",
                    "src": "https://townmapsusa.com/images/maps/map_of_xenia_il.jpg",
                    "alt": "Community map of Xenia, IL",
                    "url": "https://werewolf3788.github.io/Testpages/xenia.html"
                },
                "sailor_springs": {
                    "name": "Sailor Springs, IL",
                    "src": "https://townmapsusa.com/images/maps/map_of_sailor_springs_il.jpg",
                    "alt": "Community map of Sailor Springs, IL",
                    "url": "https://werewolf3788.github.io/Testpages/sailor-springs.html"
                },
                "louisville": {
                    "name": "Louisville, IL",
                    "src": "https://townmapsusa.com/images/maps/map_of_louisville_il.jpg",
                    "alt": "Community map of Louisville, IL",
                    "url": "https://werewolf3788.github.io/Testpages/louisville.html"
                }
            };
            
            let mappedKey = activeTown.replace(/[^a-z0-9_]/g, '').trim();
            if (mappedKey === 'claycity') mappedKey = 'clay_city';
            if (mappedKey === 'sailorsprings') mappedKey = 'sailor_springs';
            
            const profile = localMapsManifest[mappedKey];
            if (profile) {
                ...
                throw new Error("Missing targeted map engine profile coordinate layout.");
            }
    ...
    async function loadGalleryImages() {
        const gallery = document.getElementById('flora-images-gallery');
        if (!gallery) return;
        try {
            ...
            arrayCollector.forEach((img, gIdx) => {
                ...
                setTimeout(() => {
                    registerDynamicLightboxTrigger(document.getElementById(galleryImgId), finalImgPath, altTitleText, "Flora Photo Record File");
                }, 50);
            });
        } catch(e) {
            gallery.innerHTML = '';
        } finally {
            // CHANGED: If the gallery container ends up completely empty (either from a bad fetch or hidden broken images), lock down and completely collapse the parent widescreen section wrapper from the view matrix.
    ...
    function initFirebaseGasIndex() {
        try {
            ...
            // Fast Stop Real-time Sync (120226)
            ...
            if (interactiveWidgetContainer) {
                ...
                if(stationImg) {
                    registerDynamicLightboxTrigger(stationImg, "https://raw.githubusercontent.com/skventuresigns-design/smlc/main/gas-prices/image/Casey's.png", "Casey's General Store Logo", "Flora Gas Index Logo");
                }
            }
        } catch(e){}
    }
